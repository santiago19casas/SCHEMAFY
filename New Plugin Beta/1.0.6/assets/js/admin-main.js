...
jQuery(document).ready(function($) {
    ...
    function getBulkSchemaPanel() {
        ...
        // RIGHT: URL Selector
        html += '<div>';
        html += '<div class="baseo-panel-header" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); padding: 25px; border-radius: 12px; margin-bottom: 20px;">';
        html += '<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">';
        html += '<h3 style="margin: 0; font-size: 1.3em;">📂 ' + t('select_urls', 'Select URLs') + ' (<span id="baseo-bulk-url-count">0</span> ' + t('urls_selected', 'selected') + ')</h3>';
        html += '</div>';
        
        html += '<div style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px;">';
        html += '<select id="baseo-bulk-filter-type" class="baseo-select" style="flex: 1;">';
        ...
        html += '<div id="baseo-bulk-urls-loaded" style="margin-top: 12px; font-size: 13px; color: #6c757d;"></div>';
        html += '</div>';
        
        html += '<div id="baseo-url-selector" style="margin-bottom: 20px;"></div>';
        
        html += '<button type="submit" id="baseo-bulk-apply-btn" form="baseo-bulk-schema-form" class="baseo-btn baseo-btn-warning" style="width: 100%;" disabled>';
