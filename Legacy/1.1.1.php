    ...
    public function admin_page() {
        ...
        <div class="wrap baseo-schema-wrap">
            ...
            <div class="baseo-main-content">
                <!-- Top row: Add Schema and Configured Schemas -->
                ...
                <!-- Bottom row: Bulk Schema -->
                <div class="baseo-content-bulk">
                        ...
                        <form id="baseo-bulk-form" class="baseo-form baseo-bulk-form">
                            <div class="baseo-bulk-grid">
                                ...
                                <div class="baseo-bulk-right">
                                    <div class="baseo-form-group">
                                        <label class="baseo-label">🔍 <?php _e('Select URLs', 'custom-schema-baseo'); ?></label>
        ...
        .baseo-content-grid-main {
            ...
            gap: 40px;
            margin-bottom: 40px;
            align-items: start; /* No forzar altura igual */
        }
        ...
        jQuery(document).ready(function($) {
            ...
            function loadUrlsForBulk(searchTerm = '', postType = '') {
                ...
                $.ajax({
                    ...
                    error: function() {
                        $('#baseo-urls-list').html('<div class="baseo-empty-state"><p>⌚ Connection error</p></div>');
                    }
                });
            }
            
            // Display URLs for bulk selection
            function displayUrlsForBulk(urls) {
                var container = $('#baseo-urls-list');
                
                if (urls.length === 0) {
                    container.html('<div class="baseo-empty-state"><p>🔍 No URLs found</p></div>');
                    return;
                }
            ...
            $('#baseo-search-urls').on('input', function() {
                ...
                searchUrlsTimeout = setTimeout(function() {
                    loadUrlsForBulk(searchTerm, postType);
                }, 500);
            });
            ...
            $('#baseo-select-all-urls').on('click', function() {
                $('.baseo-url-checkbox').prop('checked', true);
                updateSelectedCount();
                showNotification('☑️ All visible URLs selected', 'info');
            });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            loadUrlsForBulk(); // Refresh URLs list
                        } else {
                            showNotification('⌚ Error: ' + response.data, 'error');
                        }
                    },
